// https://claude.ai/chat/accc8416-433a-4e3d-8a8c-059730b613c5
"use client"
import React, { useState, useEffect, useRef } from 'react';
import tao38Data from './tao38.json';

const Tao38: React.FC = () => {
 const [selectedLine, setSelectedLine] = useState<{text: string, translation: string} | null>(null);
 const { tao38Text } = tao38Data;
 ...
 return (
   <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
     <div 
       ref={containerRef}
       className="w-[400px] text-left writing-mode-vertical text-2xl font-serif text-gray-800 leading-relaxed tracking-wider max-h-[80vh] overflow-x-auto p-8 bg-white shadow-lg rounded-lg flex flex-col-reverse select-none"
     >
       {[...tao38Text].reverse().map((line, index) => (
         <div
           key={index}
